...
export const task2PendingProjects = (): SubmittedProject[] => [
  {
    ...
    mentorUserId: 'nadia_rahman@dsta.gov.sg',
    secondaryMentor: 'Daniel Koh',
    secondaryMentorAppointment: 'Senior Specialist',
    secondaryMentorEmail: 'daniel_koh@dsta.gov.sg',
  ...
  },
  {
    ...
    mentorUserId: 'samuel_yeo@dsta.gov.sg',
    secondaryMentor: 'Priya Nair',
    secondaryMentorAppointment: 'Principal Engineer',
    secondaryMentorEmail: 'priya_nair@dsta.gov.sg',
...
export const task2ApprovedProjects = (): SubmittedProject[] => [
  {
    ...
    mentorUserId: 'michael_lim@dsta.gov.sg',
    secondaryMentor: 'Sarah Ng',
    secondaryMentorAppointment: 'Lead Engineer',
    secondaryMentorEmail: 'sarah_ng@dsta.gov.sg',
  ...
  },
  {
    ...
    mentorUserId: 'ravi_menon@dsta.gov.sg',
    secondaryMentor: 'Kevin Chua',
    secondaryMentorAppointment: 'Lead Engineer',
    secondaryMentorEmail: 'kevin_chua@dsta.gov.sg',
  ...
  },
  {
    ...
    mentorUserId: 'gerald_tan@dsta.gov.sg',
    secondaryMentor: 'Aisha Binte Omar',
    secondaryMentorAppointment: 'Senior Engineer',
    secondaryMentorEmail: 'aisha_omar@dsta.gov.sg',
