...
/* Applicant sign-in (public candidate touchpoint). Candidates click through from
   ...
   "Log in with Singpass" opens the mock Myinfo consent flow, then welcome /
   account-setup before a session is created. */
...
const APPLICANTS: { role: 'new-applicant' | 'existing-scholar-applicant'; name: string; label: string }[] = [
...
export default function LoginApplicant() {
  ...
  const [identity, setIdentity] = useState<'new-applicant' | 'existing-scholar-applicant'>('new-applicant');
